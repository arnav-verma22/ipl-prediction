# -*- coding: utf-8 -*-
"""
Created on Thu Oct  8 07:15:40 2020
...
bats = data.drop_duplicates(subset =["mid", "batsman"], keep = "first")
dummies2 = pd.get_dummies(bats[bats['bat_team'] == 'Chennai Super Kings']['batsman'], prefix = 'batsman')
matchid = data['mid']
